...
<head>
    ...
    <link rel="stylesheet" href="style/Exam time table.css">
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <nav id="sidebar" class="js-fullheight">
            ...
            <div class="p-4">
                ...
                <ul class="list-unstyled listItem px-3">
                    ...
                    <hr class="mb-0 mt-0 bg-white">
                    <li class="active"><a href="Exam time table.php" class="text-decoration-none px-3 py-2 d-block">
        ...
        <div class="home">
            <div class="container mt-1">
                <h1 class="display-6 text-center"><i class="fa-solid fa-calendar-days text-primary"></i> Exams<span
        ...
        <script src="js/Exam time table.js"></script>
