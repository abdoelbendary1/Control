                        ...
                        <div class="info">
                            <div class="student-info">
                                <div class="left-info">
                                    ...
                                    <div class="info">
                                        <label class="info-label" for="name">ID:</label>
                                        <span class="info-text" id="student-id"><?php echo $row['student_id'] ?></span>
                                    </div>
                                    <div class="info">
                                        <label class="info-label" for="rule">Rule:</label>
                                        <span class="info-text" id="student-grade"><?php echo $row['grade'] ?></span>
                                    </div>
                                    <div class="info">
                                        <label class="info-label" for="gpa">GPA:</label>
                                        <span class="info-text" id="student-gpa">3.2</span>
                                    </div>
                                    <div class="info">
                                    ...
                                    <div class="info">
                                        ...
                                        <span class="info-text"
                                            id="student-birthdate"><?php echo $row['birthdate'] ?></span>
                                    </div>
                                    <div class="info last-info">
                                        <label class="info-label" for="phone">Phone Number:</label>
                                        <span class="info-text"
                                            id="student-phone"><?php echo $row['phone_number'] ?></span>
                                    </div>
                                </div>
                                <div class="right-info">
                                    <img class="student-image rounded-circle" id="student-image"
