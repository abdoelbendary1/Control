...
$sql = "SELECT * FROM `course` WHERE `grade` = '$grade'";
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div class="home">
            <div class="container mt-1">
                <h1 class="display-6 mb-5"><i class="fa fa-user-check text-primary"></i> Your<span class="text-primary">
                        Attendance</span></h1><br>
                    ...
                    <table class="table table-striped text-center">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="attendance-count">Attendance Count</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                $idd = $row['course_id'];
                                $sql = "SELECT * FROM `attendance` WHERE `student_id` = '$id' and `course_id` = ' $idd '";
                                $res1 = $conn->query($sql);


                            ?>
                            <tr>
                                <td class="course-name" id="course1"><?php echo $row['course_name']; ?></td>
                                <td class="att-count" id="att-count-1"><?php echo $res1->rowCount(); ?></td>
                            </tr>
