    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <nav id="sidebar" class="js-fullheight">
            ...
            <div class="p-4">
                ...
                <ul class="list-unstyled listItem px-3">
                    ...
                    <hr class="mb-0 mt-0 bg-white">
                    <li class="active"><a href="Resources.php" class="text-decoration-none px-3 py-2 d-block">
        ...
        <div class="home">
            ...
            <div class="container mt-1">
                <h1 class="display-6"><i class="fa-solid fa-book text-primary"></i> RESOURCES<span class="text-primary">
                        LIST</span></h1>
                ...
                <div class="table-responsive">
                    <?php
                    // Select all resources from database
                    ...
                    if ($result->rowCount() > 0) {
                        ...
                        $html_table = '<table class="table table-striped text-center">';
                        $html_table .= '<thead><tr><th>Resource Name</th><th>Link</th></tr></thead>';

                        // Loop through each resource and add to HTML table
                        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                            $resource_name   = $row['resource_name'];
                            $link = $row['link'];

                            $html_table .= '<tr>';
                            $html_table .= "<td> " . $resource_name .  ' </td>';
                            $html_table .= "<td> <a href='" . $row['link'] . "' >" . $link . "</a></td>";
                            $html_table .= '</tr>';
                        }
