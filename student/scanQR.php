...
<head>
    ...
    <link rel="stylesheet" href="style/scanQR.css">
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <nav id="sidebar" class="js-fullheight">
            ...
            <div class="p-4">
                ...
                <ul class="list-unstyled listItem px-3">
                    ...
                    <li class="active"><a href="scanQR.php" class="text-decoration-none px-3 py-2 d-block">
        ...
        <div class="home">
            <div class="container mt-1">
                <h1 class="display-6 mb-5"><i class="fa fa-expand text-primary"></i> QR<span class="text-primary">
                        Scanner</span></h1><br>
                <div class="scanner">
                    <video id="video">
