...
$iddd = $_SESSION['id'];
$select1 =  "SELECT * FROM `course` where `stuff_id` = '$iddd'   ";
...
<head>
    ...
    <link rel="stylesheet" href="style/view-result.css">
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <nav id="sidebar" class="js-fullheight">
            ...
            <div class="p-4">
                ...
                <ul class="list-unstyled listItem px-3">
                    ...
                    <li class="active"><a href="view-result.php" class="text-decoration-none px-3 py-2 d-block">
        ...
        <div class="home">
            <div class="container mt-1">
                <h1 class="display-6"><i class="fa fa-graduation-cap text-primary"></i> View<span class="text-primary">
                        Results</span></h1>
                <form>
                    <div class="container">
                        <div class="row">
                            <label for="mySelect"><b>Choose Course:</b></label>
