...
<body>
    <div class="wrapper d-flex align-items-stretch">
        ...
        <nav id="sidebar" class="js-fullheight">
            ...
            <div class="p-4">
                ...
                <ul class="list-unstyled listItem px-3">
                    <li class="active"><a href="home.php" class="text-decoration-none px-3 py-2 d-block">
        ...
        <div class="home">
            ...
            <h1 class="display-6 mb-1"><i class="fa fa-house text-primary"></i><span class="text-primary">
                        Home</span></h1>
                <br>
                <h4 class="display-6 mb-5"> Welcome Back!.. <i class="fa-regular fa-face-smile-beam"></i><span class="text-primary">&nbsp; <?php echo $row['name'] ?></span></h4>
                            ...
                            <div class="staff-info">
                                <div class="left-info">
                                    <div class="info">
                                        ...
                                        <span class="info-text" id="staff-name"><?php echo $row['name'] ?></span>
                                    </div>
                                    <div class="info">
                                        <label class="info-label" for="name">Gender:</label>
                                        <span class="info-text" id="staff-gender"><?php echo $row['gender'] ?></span>
                                    </div>
                                    <div class="info">
                                        <label class="info-label" for="email">Email:</label>
                                        <span class="info-text" id="staff-email"><?php echo $row['email'] ?></span>
                                    </div>
                                    <div class="info">
                                        <label class="info-label" for="staff-id">ID:</label>
                                        <span class="info-text" id="staff-id"><?php echo $row['stuff_id'] ?></span>
                                    </div>
                                    <div class="info">
                                        <label class="info-label" for="position">Position:</label>
                                        <span class="info-text" id="staff-position"><?php echo $row['grade'] ?></span>
                                    </div>
                                    <div class="info">
                                        <label class="info-label" for="phone">Phone Number:</label>
                                        <span class="info-text"
                                            id="staff-phone"><?php echo $row['phone_number'] ?></span>
                                    </div>
                                </div>
                                <div class="right-info">
                                    <img class="staff-image rounded-circle" id="staff-image"
