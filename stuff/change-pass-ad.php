...
if (isset($_POST['current-password'])) {
    ...
    if ($new == $confirm) {
        $sql = "SELECT * FROM `stuff` WHERE `email` = '$email'";
        $res = $conn->query($sql);
        $count = $res->rowCount();
        ...
        if ($res->rowCount() > 0) {
            ...
            $sql1 = "UPDATE `stuff` SET `password`='$new' WHERE `email` = '$email' ";
            $res = $conn->query($sql1);
        } else {
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <nav id="sidebar" class="js-fullheight">
            ...
            <div class="sidebar-buttons">
                <a class="active" href="change-pass-ad.php"><button id="changePass">Change Password</button></a>
                ...
                <form>
                    ...
                    <div class="password-input-container">
                        <input type="password" id="current-password" name="current-password"
                            style="margin-bottom: 20px !important" class="form-control" name="password" value=""
                            required>
