        ...
        <nav id="sidebar" class="js-fullheight">
            ...
            <div class="p-4">
                ...
                <ul class="list-unstyled listItem px-3">
                    ...
                    <hr class="mb-0 mt-0 bg-white">
                    <li class="active"><a href="notice board.php" class="text-decoration-none px-3 py-2 d-block">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6 mt-4">
                        <div class="card message-container">
                            <h2 class="message-title">Notice Board</h2>
                            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                                <div class="form-group">
                                    <label for="subject" class="subject">Subject: </label>
                                    <input type="text" name="subject" maxlength="45" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label for="message" class="message">Message: </label>
                                    <textarea name="message" cols="30" rows="7" required maxlength="500"
                                        class="form-control"></textarea>
                                </div>
                                <label for="mySelect">Send To: </label>
                                <div class="col mb-2">
                                    <select class="" name="select" id="mySelect" onchange="filterTable()" required>
                                ...
                                if (isset($_POST["submit"])) {
                                    ...
                                    $execution = $stmt->execute([$_POST['subject'], $_POST['message'], $_POST['select']]);

                                    if ($execution) {
                                        echo "<div style='  color: #842029;background-color: #198754;color: white;padding :10px'>message send successfully</div>";
                                    } else {
                                        echo "<div style='  color: #842029;background-color: #f8d7da;color: 842029;padding :10px'>message doesn't send </div>";
                                    }
                                }
