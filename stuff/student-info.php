...
<head>
    ...
    <link rel="stylesheet" href="style/student-info.css">
...
<body>
    <div class="wrapper d-flex align-items-stretch">
        ...
        <nav id="sidebar" class="js-fullheight">
            ...
            <div class="p-4">
                ...
                <ul class="list-unstyled listItem px-3">
                    ...
                    <hr class="mb-0 mt-0 bg-white">
                    <li class="active"><a href="student-info.php" class="text-decoration-none px-3 py-2 d-block">
        ...
        <div class="home">
            <div class="container mt-1">
                <h1 class="display-6"><i class="fa fa-user-graduate text-primary"></i> Students<span
                        class="text-primary"> Info</span></h1>
                <form>
                    <div class="container">
                        <div class="row">
                            <label for="mySelect"><b>Current Rule:</b></label>
                            <div class="col-md-6 mb-2">
                                <select class="" id="mySelect" onchange="filterTable()">
                    ...
                    <table class="table table-striped text-center">
                        ...
                        <tbody id="student-table">
                            ...
                            <tr>
                                ...
                                <?php echo '<td style="    padding-top: 50px;">' . $row['gender'] .  '</td>' ?>
                                <?php echo '<td>' . $row['name'] .  '</td>' ?>
                                <?php echo '<td>' . $row['phone_number'] .  '</td>' ?>
                                <?php echo '<td>' . $row['birthdate'] .  '</td>' ?>
                                <?php echo '<td>' . '<img src="' . "../photos/" . $row['student_id'] . ".png" . '" alt="st img" class="rounded-circle">' ?>

                                <?php echo '<td style="    padding-top: 50px;">' . $row['grade'] .  '</td>' ?>
                            </tr>
                            <?php }
                            ?>
    ...
    <script src="JS/students-info.js"></script>
