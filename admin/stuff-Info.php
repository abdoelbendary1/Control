...
if (isset($_GET['email']) && $_GET['type'] = 'stuff') {
    $email = $_GET['email'];
    $query2 = ("SELECT * FROM stuff where email= '$email'");
    ...
    <nav id="sidebar" class="js-fullheight">
                ...
                <li class="dropdown active" >
                    ...
                    <ul class="dropdown-menu st-option" aria-labelledby="dropdown">
                        <li><a class="dropdown-item" href="allStuff.php">&nbsp;
                            <i class="fa-solid fa-users fa-fw"></i>&nbsp;
                            All Staff</a></li>
                        <li><a class="dropdown-item active" href="stuff-Info.php">&nbsp;
        ...
        <div class="home ">
            <div class="container mt-1">
                <h1 class="display-6"><i class="fa fa-user-tie text-primary"></i> <span class="text-primary"><?php echo $row['name'] ?></span></h1><br>
                        ...
                        <div class="student-info">
                            <div class="left-info">
                                ...
                                <div class="info">
                                    ...
                                    <span class="info-text" id="stuff-id"><?php echo $row['stuff_id'] ?></span>
                                </div>
                                <div class="info">
                                    <label class="info-label" for="grade">grade:
                                        </label>
                                    <span class="info-text" id="grade"><?php echo $row['grade'] ?></span>
                                </div>
                            ...
                            <div class="right-info">
                                ...
                                <img class="student-image" id="student-image"
                                    src="../photos/<?php echo $row['stuff_id'] . $row['name'] . ".png"  ?>"
                                    alt="Student Image">
                            </div>
                        </div>
                    </div>
