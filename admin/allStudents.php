...
<body>
    ...
    <nav id="sidebar" class="js-fullheight">
            ...
            <ul class="list-unstyled listItem px-3">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu st-option" aria-labelledby="dropdown">
                        <li><a class="dropdown-item active" href="allStudents.php">&nbsp;
        ...
        <div class="home">
          ...
          <h1 class="display-6"><i class="text-primary fa-solid fa-users fa-fw"></i> All<span class="text-primary"> students</span></h1><br>
            ...
            <div class="table-wrapper">
                <table id="allStudents">
                    <thead>
                        <tr class="">
                            <th id="student-name">Name</th>
                            <th id="student-pass">Password</th>
                            <th id="student-gender">Gender</th>
                            <th id="student-email">Email</th>
                            <th id="student-dob">DOB</th>
                            <th id="student-phone">Phone Number</th>
                            <th id="">view</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary" id="view"
                                    href="studentInfo.php?email=<?php echo $row['email'] ?>&type=student">View Student
                                </a>
                            </td>
