...
if (isset($_GET['email']) && $_GET['type'] = 'student') {
    $email = $_GET['email'];
    ...
    <nav id="sidebar" class="js-fullheight">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu st-option" aria-labelledby="dropdown">
                        <li><a class="dropdown-item ju" href="allStudents.php">&nbsp;
                            ...
                            All Students</a></li>
                        <li><a class="dropdown-item active" href="studentInfo.php">&nbsp;
        ...
        <div class="home ">
            <div class="container mt-1">
                <h1 class="display-6"><i class="fa fa-user-graduate text-primary"></i> <span class="text-primary"><?php echo $row['name'] ?></span></h1><br>
                    ...
                    <div class="card-content">
                        ...
                        <div class="info">
                            <div class="student-info">
                                <div class="left-info mx-2">
                                    <div class="info">
                                        <label class="info-label" for="name">Name :
                                            </label>
                                        <span class="info-text" id="student-name"><?php echo $row['name'] ?></span>
                                    </div>
                                    <div class="info">
                                        <label class="info-label" for="email">Email :
                                            </label>
                                        <span class="info-text" id="student-email"><?php echo $row['email'] ?></span>
                                    </div>
                                    <div class="info">
                                        <label class="info-label" for="name">ID  :
                                            </label>
                                        <span class="info-text" id="student-id"><?php echo $row['student_id'] ?></span>
                                    </div>
                                    <div class="info">
                                        <label class="info-label" for="rule">Rule :
                                            </label>
                                        <span class="info-text" id="student-rule"><?php echo $row['grade'] ?></span>
                                    </div>

                                    <div class="info">
                                        <label class="info-label" for="gender">Gender  :
                                            </label>
                                        <span class="info-text" id="student-gender"><?php echo $row['gender'] ?></span>
                                    </div>
                                    <div class="info">
                                        <label class="info-label" for="dob">Date of Birth :
                                            </label>
                                        <span class="info-text" id="student-dob"><?php echo $row['birthdate'] ?></span>
                                    </div>
                                    <div class="info">
                                        <label class="info-label" for="phone">Phone Number :
                                            </label>
                                        <span class="info-text" id="student-phone"><?php echo $row['phone_number'] ?></span>
                                    </div>
                                    
                                </div>
                                <div class="right-info">

                                    <img class="student-image" id="student-image"
                                        src="../photos/<?php echo $row['student_id'] . ".png"  ?>" alt="Student Image">
                                </div>
                            </div>
                        </div>
                    </div>
